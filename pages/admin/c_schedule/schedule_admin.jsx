...
import CheckboxButton from './ScheduleTable';
const Schedule_admin_page = () => {
    ...
    return (
        < >
            ...
            <div class=" flex-col mt-2 mb-4 flex rounded-lg border-2 border-teal-400">
                ...
                <div className='flex-col py-5 mt-2 flex justify-cente'>
                    ...
                    {selectedOption && (
                        <div className=" mt-2 ml-5 mr-5 flex justify-center h-screen rounded-lg border-2 border-teal-400">
...
export default Schedule_admin_page