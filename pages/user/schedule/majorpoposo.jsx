  ...
  return (
    < >
      ...
      <div class=" flex-col mt-2 flex rounded-lg border-2 border-teal-300">
        <text className=' mt-2 mr-4 ml-4 mb-5 text-teal-400 justify-center text-center text-4xl font-Lao flex'> ຕາຕະລາງປ້ອງກັນຫົວຂໍ້ຈົບຊັ້ນປີ4 </text>
